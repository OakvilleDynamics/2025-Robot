...
public class CANRollerSubsystemCTRE extends SubsystemBase {
  ...
  public Command runRoller(CANRollerSubsystemCTRE rollerSubsystem, DoubleSupplier throttle) {
    return Commands.run(() -> rollerMotor.set(throttle.getAsDouble()), rollerSubsystem);
  }
}
